...
QBCore.Commands.Add('v1', '', {}, false, function(source, args)
    local src = source
...
QBCore.Functions.CreateCallback('adminv1:server:GetPlayerChar', function(source, cb, steam)
    local plyChars = {}
    exports['oxmysql']:execute('SELECT * FROM players WHERE steam = @steam', {['@steam'] = steam}, function(result)
        for i = 1, (#result), 1 do
